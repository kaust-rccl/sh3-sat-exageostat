...
subs = {
  ...
  'normal' : [
    ...
    ('', 'REAL',                 'DOUBLE PRECISION',      'COMPLEX',                         'DOUBLE COMPLEX'                 ),
    ...
    # Pastix
    ('int',             'float',           'double',          'pastix_complex32_t', 'pastix_complex64_t'),
    ('int',             'float',           'double',          'float',              'double'            ),
    ('PastixPattern',   'PastixFloat',     'PastixDouble',    'PastixComplex32',    'PastixComplex64'   ),
    ('PastixPattern',   'PastixFloat',     'PastixDouble',    'PastixFloat',        'PastixDouble'      ),
    ...
    # ----- Constants
    ('CblasTrans',  'CblasTrans',  'CblasTrans',  'CblasConjTrans',  'CblasConjTrans'  ),
    ('MagmaTrans',  'MagmaTrans',  'MagmaTrans',  'MagmaConjTrans',  'MagmaConjTrans'  ),
    ('MorseTrans',  'MorseTrans',  'MorseTrans',  'MorseConjTrans',  'MorseConjTrans'  ),
    ('PlasmaTrans', 'PlasmaTrans', 'PlasmaTrans', 'PlasmaConjTrans', 'PlasmaConjTrans' ),
    ('PastixTrans', 'PastixTrans', 'PastixTrans', 'PastixConjTrans', 'PastixConjTrans' ),
