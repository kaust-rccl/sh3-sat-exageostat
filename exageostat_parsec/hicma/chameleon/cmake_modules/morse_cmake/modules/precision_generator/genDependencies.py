...
class GenConversion:
  ...
  def run(self, file = None):
    ...
    for precision in self.precisions:
      ...
      #print(f"file {filename} to precision {precision}")
  ...
  def substitute(self, sub_type, data, precision):
    ...
    try:
      ...
      work = subs[sub_type];
      #print("sub_type=",sub_type,"work=",work)
      prec_to = work[0].index(precision);
      #print("sub_type=",sub_type,"work=",work,"prec_to=",prec_to)
      prec_from = work[0].index(self.precision);
      #print("sub_type=",sub_type,"work=",work,"prec_to=",prec_to,"prec_form=",prec_form)
    except:
    ...
    for i in range(1,len(work)):
      ...
      try:
        ...
        #print("i=",i,"date=",data,"search=",search,"replace=",replace)
        ...
        print('genDependencies Bad replacement pair ', i, 'in', sub_type);
        continue;
    return data;
  ...
  def convert(self, data, precision):
    ...
    try:
      ...
      #print("all substitute")
      data = self.substitute('all', data, precision);
      #print("all substitute...done")
    except: pass;
    for sub_type in self.types:
      ...
      try:
        #print("sub_type=",sub_type,"substitute","data=",data)
        data = self.substitute(sub_type, data, precision);
        #print("sub_type)",sub_type,"substitute...done")
      except Exception(e):
