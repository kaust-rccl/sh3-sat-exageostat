...
#include "hicma_z.h"
#include "hicma/aux/include/auxcompute_z.h"
#include "hicma/aux/include/auxdescutil.h"
...
void HICMA_dmle_Call(MLE_data  *data, int ncores, int ts, int N, int nZobs, int nZmiss,  int gpus, int p_grid, int q_grid);
