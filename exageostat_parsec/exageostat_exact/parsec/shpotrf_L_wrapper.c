...
parsec_shpotrf_New( parsec_context_t *parsec,
		    ...
		    int band_size, int tensor_gemm, int lookahead,
                    int *info)
{
    parsec_shpotrf_L_taskpool_t *parsec_dpotrf = NULL;
    ...
    *info = 0;
    tp = (parsec_taskpool_t*)parsec_shpotrf_L_new( uplo, A, band_size, tensor_gemm, lookahead, info );

    parsec_dpotrf = (parsec_shpotrf_L_taskpool_t*)tp;
    ...
    parsec_matrix_add2arena(parsec_dpotrf->arenas[PARSEC_shpotrf_L_DEFAULT_ARENA],
...
{
    parsec_shpotrf_L_taskpool_t *parsec_dpotrf = (parsec_shpotrf_L_taskpool_t *)tp;
    ...
    parsec_matrix_del2arena( parsec_dpotrf->arenas[PARSEC_shpotrf_L_DEFAULT_ARENA] );
 ...
 ******************************************************************************/
int
parsec_shpotrf( parsec_context_t *parsec,
               PLASMA_enum uplo,
               parsec_tiled_matrix_dc_t *A,
	       int band_size, int tensor_gemm, int lookahead)
{
    ...
    parsec_dpotrf = parsec_shpotrf_New( parsec, uplo, A, band_size, tensor_gemm, lookahead, &info );
