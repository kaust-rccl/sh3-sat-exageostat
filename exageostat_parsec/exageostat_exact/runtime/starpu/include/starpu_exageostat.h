...
int MORSE_MLE_dshift_Tile_Async(MORSE_desc_t *descA, MORSE_sequence_t *sequence,
 MORSE_request_t  *request);

int MORSE_MLE_dcmg_Tile_Async(MORSE_enum uplo, MORSE_desc_t *descA,
		MORSE_sequence_t *sequence, MORSE_request_t *request,
		location *l1, location *l2, double *theta,
		char *dm, char *c_fun);

int MORSE_MLE_scmg_Tile_Async(MORSE_enum uplo, MORSE_desc_t *descA,
		MORSE_sequence_t *sequence, MORSE_request_t *request,
		location *l1, location *l2, double *theta,
		char *dm, char *c_fun);

int MORSE_MLE_sdcmg_Tile_Async(MORSE_enum uplo, MORSE_desc_t *descA,
		MORSE_sequence_t *sequence, MORSE_request_t *request,
		location *l1, location *l2, double *theta, char *dm,
		int diag_thick, char *c_fun);
...
int MORSE_MLE_ddotp_Async(MORSE_desc_t *descA, MORSE_desc_t *descproduct,
		MORSE_sequence_t *sequence, MORSE_request_t *request);
